...
function run() {
    describe('convertDataToISO', function () {
        ...
        it('should convert DateTimeData to datetime string, -300 tz offset', function () {
            var data = {
                year: 1994,
                month: 12,
                day: 15,
    ...
    describe('convertFormatToKey', function () {
        ...
        it('should convert second formats to their DateParse key', function () {
    ...
    describe('parseTemplate', function () {
        ...
        it('should get formats from template "s ss m mm h hh H HH D DD DDD DDDD M MM MMM MMMM YY YYYY"', function () {
