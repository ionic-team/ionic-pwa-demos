...
function run() {
    describe('Refresher', function () {
        ...
        beforeEach(function () {
            ...
            gestureController = new src_1.GestureController();
            content = new src_1.Content(contentElementRef, config, null, null, zone, null, null);
            content._scrollEle = document.createElement('scroll-content');
            refresher = new src_1.Refresher(content, zone, gestureController);
        });
        function touchEv(y) {
            return {
                type: 'mockTouch',
