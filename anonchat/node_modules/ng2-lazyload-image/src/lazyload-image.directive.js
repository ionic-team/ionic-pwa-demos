...
var LazyLoadImageDirective = (function () {
    ...
    LazyLoadImageDirective.prototype.ngAfterContentInit = function () {
        var _this = this;
        this.scrollSubscription = scroll_listener_1.getScrollListener(this._scrollTarget)
            .filter(function () { return _this.isVisible(); })
            .take(1)
            .switchMap(function () { return _this.loadImage(_this.lazyImage); })
            .do(function () { return _this.setImage(_this.lazyImage); })
    ...
    ], LazyLoadImageDirective.prototype, "scrollTarget", null);
    __decorate([
        core_1.Input(), 
