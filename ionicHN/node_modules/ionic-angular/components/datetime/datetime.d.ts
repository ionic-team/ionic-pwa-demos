...
export declare const DATETIME_VALUE_ACCESSOR: Provider;
/**
 * @name DateTime
 * @description
 ...
 */
export declare class DateTime implements AfterContentInit, ControlValueAccessor, OnDestroy {
    private _form;
    private _config;
    private _item;
    private _pickerCtrl;
    ...
    constructor(_form: Form, _config: Config, _item: Item, _pickerCtrl: PickerController);
    private _click(ev);
    private _keyup();
    /**
     * @private
