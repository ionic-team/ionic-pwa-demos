...
function run() {
    describe('Config', function () {
        ...
        it('should create a new Config instace when no confg passed in ionicProviders', function () {
            var providers = src_1.ionicProviders();
            var config = providers.find(function (provider) { return provider.useValue instanceof src_1.Config; }).useValue;
            expect(config.get('mode')).toEqual('md');
        });
        it('should used passed in Config instance in ionicProviders', function () {
            var userConfig = new src_1.Config({
                mode: 'configInstance'
            });
            var providers = src_1.ionicProviders(null, userConfig);
            var config = providers.find(function (provider) { return provider.useValue instanceof src_1.Config; }).useValue;
        ...
        it('should create new Config instance from config object in ionicProviders', function () {
            var providers = src_1.ionicProviders(null, {
                mode: 'configObj'
            });
            var config = providers.find(function (provider) { return provider.useValue instanceof src_1.Config; }).useValue;
        ...
        it('should override mode settings', function () {
            ...
            var platform = new src_1.Platform(['ios']);
            config.setPlatform(platform);
            expect(config.get('mode')).toEqual('md');
        ...
        it('should override mode platform', function () {
            ...
            var platform = new src_1.Platform(['mobile']);
            config.setPlatform(platform);
            expect(config.get('mode')).toEqual('modeB');
        });
        it('should override mode', function () {
            ...
            var platform = new src_1.Platform(['core']);
            config.setPlatform(platform);
        ...
        it('should get setting from md mode', function () {
            var config = new src_1.Config();
            var platform = new src_1.Platform(['android']);
            config.setPlatform(platform);
            expect(config.get('iconMode')).toEqual('md');
        });
        ...
        it('should set/get mobile setting even w/ higher priority ios', function () {
            var config = new src_1.Config();
            var platform = new src_1.Platform(['mobile', 'ios']);
            config.setPlatform(platform);
            config.settings({
                key: 'defaultValue',
                platforms: {
        ...
        it('should create default config w/ bad settings value', function () {
            var config = new src_1.Config(null);
            expect(config.settings()).toEqual({});
            config = new src_1.Config(undefined);
            expect(config.settings()).toEqual({});
            config = new src_1.Config();
            expect(config.settings()).toEqual({});
            config = new src_1.Config([1, 2, 3]);
            expect(config.settings()).toEqual({});
            config = new src_1.Config('im bad, you know it');
            expect(config.settings()).toEqual({});
            config = new src_1.Config(8675309);
            expect(config.settings()).toEqual({});
            config = new src_1.Config(true);
            expect(config.settings()).toEqual({});
            config = new src_1.Config(false);
            expect(config.settings()).toEqual({});
            config = new src_1.Config(1);
            expect(config.settings()).toEqual({});
            config = new src_1.Config(function () { });
            expect(config.settings()).toEqual({});
        });
    });
}
