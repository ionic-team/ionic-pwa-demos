    ...
    describe('NavController', function () {
        describe('pop', function () {
            it('should do nothing if its the first view in the stack', function () {
                ...
                view1.state = nav_controller_base_1.STATE_ACTIVE;
                nav._views = [view1];
                expect(nav.length()).toBe(1);
                nav.pop();
                expect(nav.length()).toBe(1);
                expect(nav.getByIndex(0).state).toBe(nav_controller_base_1.STATE_ACTIVE);
        ...
        describe('popToRoot', function () {
            it('should go back to root', function () {
                var view1 = new src_1.ViewController(Page1);
                view1.state = nav_controller_base_1.STATE_INACTIVE;
                var view2 = new src_1.ViewController(Page2);
                view2.state = nav_controller_base_1.STATE_INACTIVE;
                var view3 = new src_1.ViewController(Page3);
                view3.state = nav_controller_base_1.STATE_INACTIVE;
                var view4 = new src_1.ViewController(Page4);
                view4.state = nav_controller_base_1.STATE_ACTIVE;
                nav._views = [view1, view2, view3, view4];
                nav.popToRoot();
                expect(nav.length()).toBe(2);
                expect(nav.getByIndex(0).state).toBe(nav_controller_base_1.STATE_INIT_ENTER);
                expect(nav.getByIndex(0).componentType).toBe(Page1);
                expect(nav.getByIndex(1).state).toBe(nav_controller_base_1.STATE_INIT_LEAVE);
                expect(nav.getByIndex(1).componentType).toBe(Page4);
                expect(view2.state).toBe(nav_controller_base_1.STATE_REMOVE);
                expect(view3.state).toBe(nav_controller_base_1.STATE_REMOVE);
            });
        });
        describe('popTo', function () {
            it('should go back two views', function () {
                ...
                expect(nav.getByIndex(0).state).toBe(nav_controller_base_1.STATE_INACTIVE);
                expect(nav.getByIndex(0).componentType).toBe(Page1);
                expect(nav.getByIndex(1).state).toBe(nav_controller_base_1.STATE_INIT_ENTER);
                expect(nav.getByIndex(1).componentType).toBe(Page2);
                expect(view3.state).toBe(nav_controller_base_1.STATE_REMOVE);
                expect(nav.getByIndex(2).state).toBe(nav_controller_base_1.STATE_INIT_LEAVE);
        ...
        describe('remove', function () {
            it('should create opts if passed in arg is undefined or null', function () {
                ...
                view1.state = nav_controller_base_1.STATE_INACTIVE;
                var view2 = new src_1.ViewController(Page2);
                view2.state = nav_controller_base_1.STATE_ACTIVE;
        ...
        describe('_remove', function () {
            it('should reassign activily transitioning leave that isnt getting removed, to become force active', function () {
                ...
                view1.state = nav_controller_base_1.STATE_INACTIVE;
                var view2 = new src_1.ViewController(Page2);
                view2.state = nav_controller_base_1.STATE_TRANS_LEAVE;
                var view3 = new src_1.ViewController(Page3);
                view3.state = nav_controller_base_1.STATE_TRANS_ENTER;
                nav._views = [view1, view2, view3];
                nav._remove(2, 1);
                expect(nav.getByIndex(0).state).toBe(nav_controller_base_1.STATE_INACTIVE);
                expect(nav.getByIndex(0).componentType).toBe(Page1);
                expect(nav.getByIndex(1).state).toBe(nav_controller_base_1.STATE_FORCE_ACTIVE);
                expect(nav.getByIndex(1).componentType).toBe(Page2);
                expect(nav.getByIndex(2).state).toBe(nav_controller_base_1.STATE_REMOVE_AFTER_TRANS);
            ...
            it('should reassign activily transitioning views that should be removed to STATE_REMOVE_AFTER_TRANS', function () {
                ...
                view1.state = nav_controller_base_1.STATE_INACTIVE;
                var view2 = new src_1.ViewController(Page2);
                view2.state = nav_controller_base_1.STATE_TRANS_ENTER;
                var view3 = new src_1.ViewController(Page3);
                view3.state = nav_controller_base_1.STATE_TRANS_LEAVE;
                nav._views = [view1, view2, view3];
                nav._remove(1, 2);
                expect(nav.getByIndex(0).state).toBe(nav_controller_base_1.STATE_INACTIVE);
                expect(nav.getByIndex(0).componentType).toBe(Page1);
                expect(nav.getByIndex(1).state).toBe(nav_controller_base_1.STATE_REMOVE_AFTER_TRANS);
                expect(nav.getByIndex(1).componentType).toBe(Page2);
                expect(nav.getByIndex(2).state).toBe(nav_controller_base_1.STATE_REMOVE_AFTER_TRANS);
                expect(nav.getByIndex(2).componentType).toBe(Page3);
            });
            it('should keep same init leave, but set previous init enter to inactive', function () {
                ...
                view1.state = nav_controller_base_1.STATE_INACTIVE;
                var view2 = new src_1.ViewController(Page2);
                view2.state = nav_controller_base_1.STATE_INIT_ENTER;
                var view3 = new src_1.ViewController(Page3);
                view3.state = nav_controller_base_1.STATE_INIT_LEAVE;
                nav._views = [view1, view2, view3];
                nav._remove(1, 1);
                expect(nav.length()).toBe(3);
                expect(view1.state).toBe(nav_controller_base_1.STATE_INIT_ENTER);
                expect(view2.state).toBe(nav_controller_base_1.STATE_CANCEL_ENTER);
                expect(view3.state).toBe(nav_controller_base_1.STATE_INIT_LEAVE);
                expect(nav.getByIndex(0).state).toBe(nav_controller_base_1.STATE_INIT_ENTER);
                expect(nav.getByIndex(0).componentType).toBe(Page1);
                expect(nav.getByIndex(1).state).toBe(nav_controller_base_1.STATE_CANCEL_ENTER);
                expect(nav.getByIndex(1).componentType).toBe(Page2);
                expect(nav.getByIndex(2).state).toBe(nav_controller_base_1.STATE_INIT_LEAVE);
                expect(nav.getByIndex(2).componentType).toBe(Page3);
            });
            it('should set to pop the active and enter the previous', function () {
                ...
                nav._remove(1, 1);
                expect(view1.state).toBe(nav_controller_base_1.STATE_INIT_ENTER);
                expect(view2.state).toBe(nav_controller_base_1.STATE_INIT_LEAVE);
            });
            it('should set to remove 2 views before active one, active stays the same', function () {
                ...
                view3.state = nav_controller_base_1.STATE_INACTIVE;
                var view4 = new src_1.ViewController(Page4);
                view4.state = nav_controller_base_1.STATE_INACTIVE;
                var view5 = new src_1.ViewController(Page5);
                view5.state = nav_controller_base_1.STATE_ACTIVE;
                nav._views = [view1, view2, view3, view4, view5];
                nav._remove(2, 2);
                expect(nav.length()).toBe(3);
                expect(view1.state).toBe(nav_controller_base_1.STATE_INACTIVE);
                expect(view2.state).toBe(nav_controller_base_1.STATE_INACTIVE);
                expect(view3.state).toBe(nav_controller_base_1.STATE_REMOVE);
                expect(view4.state).toBe(nav_controller_base_1.STATE_REMOVE);
                expect(view5.state).toBe(nav_controller_base_1.STATE_ACTIVE);
                expect(nav.getByIndex(0).state).toBe(nav_controller_base_1.STATE_INACTIVE);
                expect(nav.getByIndex(0).componentType).toBe(Page1);
                expect(nav.getByIndex(1).state).toBe(nav_controller_base_1.STATE_INACTIVE);
                expect(nav.getByIndex(1).componentType).toBe(Page2);
                expect(nav.getByIndex(2).state).toBe(nav_controller_base_1.STATE_ACTIVE);
            ...
            it('should set to remove all views other than the first', function () {
                ...
                expect(view2.state).toBe(nav_controller_base_1.STATE_REMOVE);
                expect(view3.state).toBe(nav_controller_base_1.STATE_REMOVE);
                expect(view4.state).toBe(nav_controller_base_1.STATE_INIT_LEAVE);
                expect(nav.getByIndex(0).state).toBe(nav_controller_base_1.STATE_INIT_ENTER);
                expect(nav.getByIndex(0).componentType).toBe(Page1);
                expect(nav.getByIndex(1).state).toBe(nav_controller_base_1.STATE_INIT_LEAVE);
                expect(nav.getByIndex(1).componentType).toBe(Page4);
            ...
            it('should set to remove the only view in the stack', function () {
                ...
                nav._views = [view1];
                nav._remove(0, 1);
                expect(nav.getByIndex(0).state).toBe(nav_controller_base_1.STATE_INIT_LEAVE);
            });
        ...
        describe('_cleanup', function () {
            it('should destroy views that are inactive after the active view', function () {
                ...
                view3.state = nav_controller_base_1.STATE_INACTIVE;
                var view4 = new src_1.ViewController(Page4);
                view4.state = nav_controller_base_1.STATE_TRANS_ENTER;
                var view5 = new src_1.ViewController(Page5);
                view5.state = nav_controller_base_1.STATE_INACTIVE;
                nav._views = [view1, view2, view3, view4, view5];
                nav._cleanup();
                expect(nav.length()).toBe(3);
                expect(nav.getByIndex(0).state).toBe(nav_controller_base_1.STATE_INACTIVE);
                expect(nav.getByIndex(0).componentType).toBe(Page1);
                expect(nav.getByIndex(1).state).toBe(nav_controller_base_1.STATE_ACTIVE);
                expect(nav.getByIndex(1).componentType).toBe(Page2);
                expect(nav.getByIndex(2).state).toBe(nav_controller_base_1.STATE_TRANS_ENTER);
                expect(nav.getByIndex(2).componentType).toBe(Page4);
            });
            ...
            it('should reset zIndexes if their is a negative zindex', function () {
                var view1 = new src_1.ViewController(Page1);
                view1.setPageRef(mock_providers_1.mockElementRef());
                view1.state = nav_controller_base_1.STATE_INACTIVE;
                view1.zIndex = -1;
                var view2 = new src_1.ViewController(Page2);
                view2.setPageRef(mock_providers_1.mockElementRef());
                view2.state = nav_controller_base_1.STATE_INACTIVE;
                view2.zIndex = 0;
                var view3 = new src_1.ViewController(Page3);
                view3.setPageRef(mock_providers_1.mockElementRef());
                view3.state = nav_controller_base_1.STATE_ACTIVE;
                view3.zIndex = 1;
                nav._views = [view1, view2, view3];
                nav._cleanup();
        ...
        describe('_postRender', function () {
            ...
            it('should set domShow true when isAlreadyTransitioning false for views when nav is a portal', function () {
                var view1 = new src_1.ViewController(Page1);
                var view2 = new src_1.ViewController(Page2);
                var view3 = new src_1.ViewController(Page3);
                var view4 = new src_1.ViewController(Page4);
        ...
        describe('_setZIndex', function () {
            it('should set zIndex off of the previous view to the entering view is loaded and the leavingView is not loaded', function () {
                ...
                enteringView.setPageRef(mock_providers_1.mockElementRef());
        ...
        describe('_setAnimate', function () {
            it('should be unchanged when the nav is a portal', function () {
                nav._views = [new src_1.ViewController()];
                nav._init = false;
                nav._isPortal = true;
                var opts = {};
        ...
        describe('_transFinish', function () {
            it('should remove entering view if it was already set to cancel', function () {
                var enteringView = new src_1.ViewController(Page1);
                var leavingView = new src_1.ViewController(Page2);
                enteringView.state = nav_controller_base_1.STATE_CANCEL_ENTER;
                ...
                expect(enteringView.state).toBe(nav_controller_base_1.STATE_CANCEL_ENTER);
            });
            ...
            it('should set entering/leaving to inactive, after transition that isnt the most recent', function () {
                var enteringView = new src_1.ViewController(Page1);
                enteringView.state = nav_controller_base_1.STATE_TRANS_ENTER;
                var leavingView = new src_1.ViewController(Page2);
                leavingView.state = nav_controller_base_1.STATE_TRANS_LEAVE;
                var direction = 'foward';
                var updateUrl = false;
                var hasCompleted = true;
                nav._transIds = 2;
                nav._transFinish(1, enteringView, leavingView, direction, updateUrl, hasCompleted);
                expect(enteringView.state).toBe(nav_controller_base_1.STATE_INACTIVE);
                expect(leavingView.state).toBe(nav_controller_base_1.STATE_INACTIVE);
            });
            it('should set entering active, leaving inactive, after transition', function () {
                ...
                nav._transIds = 1;
                nav._transFinish(1, enteringView, leavingView, direction, updateUrl, hasCompleted);
                expect(enteringView.state).toBe(nav_controller_base_1.STATE_ACTIVE);
                expect(leavingView.state).toBe(nav_controller_base_1.STATE_INACTIVE);
            });
            it('should set entering inactive, leaving active, after transition has not completed', function () {
                ...
                nav._transFinish(1, enteringView, leavingView, direction, updateUrl, hasCompleted);
                expect(enteringView.state).toBe(nav_controller_base_1.STATE_INACTIVE);
                expect(leavingView.state).toBe(nav_controller_base_1.STATE_ACTIVE);
            });
            ...
            it('should not re-enable app when transition time > 0', function () {
                ...
                spyOn(nav._app, 'setEnabled');
                spyOn(nav, 'setTransitioning');
                nav.getLongestTrans = function () { return 50; };
                // act
                nav._transFinish(nav._transIds, enteringView, leavingView, direction, updateUrl, hasCompleted);
                // assert
        ...
        describe('_insert', function () {
            it('should push page when previous transition is still actively transitioning', function () {
                var view1 = new src_1.ViewController(Page1);
                view1.state = nav_controller_base_1.STATE_TRANS_ENTER;
                var view2 = new src_1.ViewController(Page2);
                view2.state = nav_controller_base_1.STATE_TRANS_LEAVE;
                nav._views = [view1, view2];
                var view3 = new src_1.ViewController(Page3);
                nav._insert(-1, [view3]);
                expect(nav.getByIndex(0).state).toBe(nav_controller_base_1.STATE_TRANS_ENTER);
                expect(nav.getByIndex(0).componentType).toBe(Page1);
                expect(nav.getByIndex(1).state).toBe(nav_controller_base_1.STATE_TRANS_LEAVE);
                expect(nav.getByIndex(1).componentType).toBe(Page2);
                expect(nav.getByIndex(2).state).toBe(nav_controller_base_1.STATE_INIT_ENTER);
                expect(nav.getByIndex(2).componentType).toBe(Page3);
            });
            it('should push page when previous transition views init, but havent transitioned yet', function () {
                var view1 = new src_1.ViewController(Page1);
                view1.state = nav_controller_base_1.STATE_INIT_LEAVE;
                var view2 = new src_1.ViewController(Page2);
                view2.state = nav_controller_base_1.STATE_INIT_ENTER;
                nav._views = [view1, view2];
                var view3 = new src_1.ViewController(Page3);
            ...
            it('should insert multiple pages, back to back, no starting active page', function () {
                ...
                expect(nav.getByIndex(2).state).toBe(nav_controller_base_1.STATE_INACTIVE);
            ...
            it('should insert 3 pages', function () {
                ...
                expect(nav.getByIndex(2).state).toBe(nav_controller_base_1.STATE_INACTIVE);
                expect(nav.getByIndex(2).componentType).toBe(Page3);
                expect(nav.getByIndex(3).state).toBe(nav_controller_base_1.STATE_INIT_ENTER);
        ...
        describe('getActive', function () {
            it('should getActive()', function () {
                ...
                var view1 = new src_1.ViewController(Page1);
                view1.state = nav_controller_base_1.STATE_INIT_ENTER;
                nav._views = [view1];
                expect(nav.getActive()).toBe(null);
                view1.state = nav_controller_base_1.STATE_ACTIVE;
        ...
        describe('getByState', function () {
            it('should getByState()', function () {
                ...
                expect(nav.getByState(nav_controller_base_1.STATE_INIT_ENTER)).toBe(view2);
                view2.state = nav_controller_base_1.STATE_INACTIVE;
                expect(nav.getByState(nav_controller_base_1.STATE_INIT_ENTER)).toBe(view1);
                view2.state = nav_controller_base_1.STATE_ACTIVE;
        ...
        describe('_beforeTrans', function () {
            it('shouldnt disable app on short transition', function () {
                ...
                nav._createTrans = mock_providers_1.mockTransition(executeAssertions, 50);
                spyOn(nav._app, 'setEnabled');
                spyOn(nav, 'setTransitioning');
                var view1 = new src_1.ViewController(Page1);
                var view2 = new src_1.ViewController(Page2);
            ...
            it('should disable app on longer transition', function () {
                ...
                nav._createTrans = mock_providers_1.mockTransition(executeAssertions, 200);
                spyOn(nav._app, 'setEnabled');
                spyOn(nav, 'setTransitioning');
                var view1 = new src_1.ViewController(Page1);
                var view2 = new src_1.ViewController(Page2);
            ...
            it('should disable app w/ padding when keyboard is open', function () {
                ...
                nav._createTrans = mock_providers_1.mockTransition(executeAssertions, 200);
                nav._keyboard.isOpen = function () { return true; };
                spyOn(nav._app, 'setEnabled');
                spyOn(nav, 'setTransitioning');
                var view1 = new src_1.ViewController(Page1);
                var view2 = new src_1.ViewController(Page2);
            ...
            it('shouldnt update app enabled when parent transition is occurring', function () {
                ...
                spyOn(nav._app, 'setEnabled');
                spyOn(nav, 'setTransitioning');
                nav.getLongestTrans = function () { return Date.now() + 100; };
                var view1 = new src_1.ViewController(Page1);
                var view2 = new src_1.ViewController(Page2);
                // act
                nav._beforeTrans(view1, view2, {}, function () { });
            });
            it('should not begin transition when entering stated is inactive', function () {
                var view1 = new src_1.ViewController(Page1);
                view1.state = nav_controller_base_1.STATE_INACTIVE;
                ...
                expect(view1.state).toEqual(nav_controller_base_1.STATE_INACTIVE);
            });
            it('should not begin transition when entering state is canceled', function () {
                var view1 = new src_1.ViewController(Page1);
                view1.state = nav_controller_base_1.STATE_CANCEL_ENTER;
                var wasDoneCalled = false;
                var done = function () {
                    wasDoneCalled = true;
                };
                nav._beforeTrans(view1, null, {}, done);
                expect(wasDoneCalled).toEqual(true);
                expect(view1.state).toEqual(nav_controller_base_1.STATE_CANCEL_ENTER);
            });
        });
        /* private method */
        describe('getLongestTrans', function () {
            it('should return 0 when transition end time is less than 0', function () {
                // arrange
                nav.parent = null;
                // act
                var returnedValue = nav.getLongestTrans(Date.now());
                // asssert
